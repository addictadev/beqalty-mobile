import 'addresses_response_model.dart';

/// Model for updating an existing address via PUT request
/// Matches the API form-data structure for updating addresses
class UpdateAddressRequestModel {
  ...
  /// Creates an UpdateAddressRequestModel from an existing AddressModel
  factory UpdateAddressRequestModel.fromAddressModel(AddressModel address) {
  ...
  /// Converts UpdateAddressRequestModel to JSON for API requests
  ...
  UpdateAddressRequestModel copyWith({
    String? title,
    String? street,
    String? city,
    String? floor,
  ...
  @override
  String toString() {
    return 'UpdateAddressRequestModel(title: $title, street: $street, city: $city, isDefault: $isDefault, lat: $lat, lng: $lng)';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is UpdateAddressRequestModel &&
        other.title == title &&
        other.street == street &&
        other.city == city &&
        other.floor == floor &&
